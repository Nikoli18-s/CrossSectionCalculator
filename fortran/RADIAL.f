...
C  WITH NDIM=800 (CHANGE THE VALUE OF THIS PARAMETER IN _ALL_           ADBP0387
...
C                                                                       ADBP0462
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG)                   ADBP0464
...
C                                                                       ADBP0536
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG)                   ADBP0538
...
C                                                                       ADBP0818
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG,                   ADBP0820
...
C                                                                       ADBP1117
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG,                   ADBP1119
...
C  ****  FINITE RANGE FIELDS.                                           ADBP1188
      ...
      BNL1=BESJNP(2,L+1,X)                                              ADBP1199
      IF(DABS(BNL1).GT.100.0D0) GO TO 2                                 ADBP1200
      BNL=BESJNP(2,L,X)                                                 ADBP1201
      BJL=BESJNP(1,L,X)                                                 ADBP1202
      BJL1=BESJNP(1,L+1,X)                                              ADBP1203
      ILAST=IL                                                          ADBP1204
...
C                                                                       ADBP1314
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG,                   ADBP1316
...
C  ****  FINITE RANGE FIELDS.                                           ADBP1399
      ...
      BNL=BESJNP(2,L,X)                                                 ADBP1411
      IF(DABS(BNL).GT.100.0D0) GO TO 2                                  ADBP1412
      BNL1=BESJNP(2,L+KSIGN,X)                                          ADBP1413
      IF(DABS(BNL1).GT.100.0D0) GO TO 2                                 ADBP1414
      BJL=BESJNP(1,L,X)                                                 ADBP1415
      BJL1=BESJNP(1,L+KSIGN,X)                                          ADBP1416
      ILAST=IL                                                          ADBP1417
...
C                                                                       ADBP1541
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG)                   ADBP1543
...
C                                                                       ADBP1593
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG,                   ADBP1595
...
C                                                                       ADBP1665
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG)                   ADBP1667
...
C                                                                       ADBP1717
      ...
      PARAMETER (NDIM=800,NPPG=NDIM+1,NPTG=NDIM+NPPG,                   ADBP1719
...
C                                                                       ADBP2382
    1 CONTINUE                                                          ADBP2383
      F=X*BESJNP(1,L,X)                                                 ADBP2384
      G=-X*BESJNP(2,L,X)                                                ADBP2385
      FP=((L+1)*BESJNP(1,L,X)-X*BESJNP(1,L+1,X))*WAVNUM                 ADBP2386
      GP=-((L+1)*BESJNP(2,L,X)-X*BESJNP(2,L+1,X))*WAVNUM                ADBP2387
